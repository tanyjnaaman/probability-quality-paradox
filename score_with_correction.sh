...
file_paths_sampling_types_temps=(
    ...
    # ancestral_strict
    "kaist-ai-janus-dpo-7b_l256_promptseed42_numprompt1000_numgenerations2_ancestral_strict_t0.5_humanassistant.csv,top_k50,0.5"
    "kaist-ai-janus-dpo-7b_l256_promptseed42_numprompt1000_numgenerations2_ancestral_strict_t0.75_humanassistant.csv,top_k50,0.75"
    "kaist-ai-janus-dpo-7b_l256_promptseed42_numprompt1000_numgenerations2_ancestral_strict_t1.0_humanassistant.csv,top_k50,1.0"
    "kaist-ai-janus-dpo-7b_l256_promptseed42_numprompt1000_numgenerations2_ancestral_strict_t1.25_humanassistant.csv,top_k50,1.25"
    "kaist-ai-janus-dpo-7b_l256_promptseed42_numprompt1000_numgenerations2_ancestral_strict_t1.5_humanassistant.csv,top_k50,1.5"
    # top_k50
...
for line in $file_paths_sampling_types_temps; do
    ...
    python -m src.experiments.language_model_experiments.score_sample_reward --csv-file-path $file_path --batch-size $batch_size --add-human-assistant-format --reward-model $reward_model
