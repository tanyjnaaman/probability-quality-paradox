...
from src.packages.safe_rlhf.values.cost.trainer import CostTrainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    training_parser.add_argument(
        ...
        help=(
            "Calculate ranking loss with all token-wise cost outputs in the sequence or"
            " the sequence-wise cost output only (the cost of the last token in each"
            " sequence)."
        ),
    )
    training_parser.add_argument(
