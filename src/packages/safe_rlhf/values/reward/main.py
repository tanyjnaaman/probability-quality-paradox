...
from src.packages.safe_rlhf.configs import get_deepspeed_train_config
...
from src.packages.safe_rlhf.values.reward.trainer import RewardTrainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    training_parser.add_argument(
        ...
        help=(
            "Calculate ranking loss with all token-wise reward outputs in the sequence"
            " or the sequence-wise reward output only (the reward of the last token in"
            " each sequence)."
        ),
    )
    training_parser.add_argument(
