...
from src.packages.safe_rlhf.algorithms.ppo_reward_shaping.trainer import (
    PPORewardShapingTrainer,
)
from src.packages.safe_rlhf.configs import (
    get_deepspeed_eval_config,
    get_deepspeed_train_config,
)
from src.packages.safe_rlhf.datasets import parse_dataset
from src.packages.safe_rlhf.logger import set_logger_level
from src.packages.safe_rlhf.utils import seed_everything, str2bool
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Train language model using Safe-RLHF with PPO algorithm and reward"
            " shaping."
        ),
    ...
    training_parser.add_argument(
        ...
        default=0.02,
        help=(
            "The coefficient for the KL divergence between the reference and actor"
            " policy."
        ),
    )
    training_parser.add_argument(
    ...
    training_parser.add_argument(
        ...
        default=1e-5,
        help=(
            "Initial learning rate (after the potential warmup period) for the actor"
            " model training."
        ),
    )
    training_parser.add_argument(
    ...
    training_parser.add_argument(
        ...
        default=0.0,
        help=(
            "Ratio of warm steps over total training steps for the actor lr scheduler."
        ),
    )
    training_parser.add_argument(
    ...
    training_parser.add_argument(
        ...
        default=5e-6,
        help=(
            "Initial learning rate (after the potential warmup period) for the critic"
            " model training."
        ),
    )
    training_parser.add_argument(
    ...
    training_parser.add_argument(
        ...
        default=0.0,
        help=(
            "Ratio of warm steps over total training steps for the critic lr scheduler."
        ),
    )
    training_parser.add_argument(
